  ...
  public void run() {
	    try {
            ...
            //Method accept() wait until a client requests a connection; then it returns a Socket that connects the client to the server
			    ...
			    System.out.println("Sensor1 received: " + line); 
                ...
                toServer.println("Sensor1's coordinates are: " + t[0] + " " + t[1] + " Target's angle is: " + String.format("%.2f", angle)); 
		        String line2 = fromServer.readLine();
		        System.out.println("Sensor1 received: " + line2);
		        toServer.close();
		        fromServer.close();
		        socket.close();
